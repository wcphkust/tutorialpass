...
static string cxx_demangle(const std::string &mangled_name) {
...
static string demangle_class_name(const std::string &demangled_name) {
...
static string llvm_class_name(const std::string &classN) {

    return "class." + classN;
}

// get only function name : A::foo(int) -> foo(int)
static string get_called_function_name(const std::string s) {
