...
//Live Variable Analysis Basic Block Version
...
//------------------------------------------------------------------------------
// Live Variable Analysis by Basic Block
//------------------------------------------------------------------------------
...
namespace {
    ...
    struct LiveVariableViaBB : public llvm::FunctionPass {
        static char ID;
        ...
        LiveVariableViaBB() : llvm::FunctionPass(ID) {}
