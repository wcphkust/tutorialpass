...
*/
bool LiveVariableInLoop::isEqualBitVector(BitVectorMap &bv1, BitVectorMap &bv2) {
    for (auto it = bv1.begin(); it != bv1.end(); it++) {
 ...
 */
bool LiveVariableInLoop::hasReachedFixedPoint(BasicBlock* bb, BitVectorMap &connectBV) {
 ...
 */
BitVectorMap LiveVariableInLoop::getLivenessInSingleBB(BasicBlock *bb, BitVectorMap &bv) {
 ...
 * Return: the liveness info the first statement
 */
BitVectorMap LiveVariableInLoop::getLivenessInLastBB(Function &F) {
 ...
 */
BitVectorMap LiveVariableInLoop::generateEmptyBitVector() {
    BitVectorMap bv;
 ...
 */
BitVectorMap LiveVariableInLoop::transferFunction(BitVectorMap &bv, BitVectorBase &KillBase, BitVectorBase &GenBase) {
...
static RegisterPass<LiveVariableInLoop> X("live-var-in-loop", "LiveVariableInLoop Pass",
